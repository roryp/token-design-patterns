...
public class PatternCatalog {
    ...
    private static PatternDefinition router() {
        return new PatternDefinition(
                ...
                "Sequence and conditional workflows share the selected route through AgenticScope.",
    ...
    private static PatternDefinition toolUse() {
        return new PatternDefinition(
                ...
                "The calculator runs as a non-AI @Agent in a sequence workflow. It reads the labeled input and output token counts and both per-million rates; missing, negative, or ambiguous values are rejected before any model call.",
    ...
    private static PatternDefinition batching() {
        return new PatternDefinition(
                ...
                "A parallelMapperBuilder workflow coordinates the fan-out and preserves a single top-level execution trace.",
